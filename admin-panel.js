...
async loadReturnRequestsFromSupabase() {
    ...
    try {
        ...
        if (error) {
            // Agar table nahi hai toh error show mat karo
...
// ✅ YEH NAYA FUNCTION YAHAN ADD KARO - loadReturnRequestsFromSupabase KE BAAD
setupRealtimeSubscriptions() {
    ...
    try {
        ...
        console.log('⚠️ Real-time subscriptions failed (tables not created yet)');
    }
}
